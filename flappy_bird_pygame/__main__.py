...
def pipe_score_check():
    ...
    if pipe_list:
        for pipe in pipe_list:
            if 98 < pipe.centerx < 101 and can_score:
                score += 1
                score_sound.play()
                can_score = False
            if pipe.centerx < -20:
...
#pygame.mixer.pre_init(frequency = 48000, size = -16, buffer = 1024)
...
hit_sound = pygame.mixer.Sound("sounds/sound_sfx_hit.wav")
death_sound = pygame.mixer.Sound("sounds/sound_sfx_die.wav")
